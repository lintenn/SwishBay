                ...
                <div class="container-fluid">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" href="PujasServlet">Mis pujas</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-sm-12 mt-0">
                            <div class="row justify-content-center">
                                ...
                                <p class="card-text text-dark text-center mb-2" style="height: 72px"><%= producto.getDescripcion()%></p>
                                <p class="card-text"><small class="text-muted">Fin de puja: <%= str%></small></p>

                                <div class="row justify-content-center pb-2 px-0">
                                    <a href="EnPujaNuevoServlet?id=<%=producto.getId()%>" class="btn btn-primary col-4 mx-3" style="width: 100px">Modificar</a>

                                    <a href="PujaBorrarServlet?id=<%=producto.getId()%>" class="btn btn-danger col-2 mx-3">
