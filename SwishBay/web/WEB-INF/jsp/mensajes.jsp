        ...
        <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
            ...
            <main class="row d-flex justify-content-center mt-4">
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <a href="MensajeNuevoEditarServlet?idGrupo=<%=str%>" class="btn btn-lg btn-secondary fw-bold border-white">Crear nuevo mensaje</a>
                </div>
            ...
            <tr>
                ...
                <td>
                    <a href="MensajeBorrarServlet?id=<%= mensaje.getId() %>&&idGrupo=<%= str %>" class="btn btn-danger">
